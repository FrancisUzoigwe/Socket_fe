        ...
        <div className="w-full h-screen bg-gradient-to-r from-purple-900 via-purple-700 to-purple-500 flex items-center justify-center">
            <form onSubmit={onHandleSubmit} className=" w-[90%] flex items-center max-md:flex-col max-md:items-center">
                ...
                <div className="ml-2 min-w-[300px] rounded-md bg-white h-[230px] flex flex-col items-center">
                    <div className="font-semibold text-xl  mt-[2px]">Register</div>
                    ...
                    <div className="text-[14px] w-[90%] flex justify-end my-2">Already have an account?
                        <Link to="/auth/signin"><span className="ml-1 hover:underline transition-all duration-300 hover:cursor-pointer hover:text-[red] text-[purple] ">Signin</span></Link></div>
                    <div className="w-[90%] h-[45px]">
                        <button className="bg-purple-600 h-full w-full rounded-md flex items-center justify-center text-white" type="submit">Signup</button>
                    </div>
                </div>
            </form>
        </div>
